...
public class Constants {
	...
	public static final String TRADINGSYMBOL = "CRUDEOIL23MARFUT";
	...
	/*
	 * These are commonly used order statuses but there are many other order
	 * statuses. Some of the statuses are only intermediate.
	 */
